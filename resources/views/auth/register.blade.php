        ...
        <section class="auth-panel">
            ...
            <div class="auth-form-pane">
                <div class="auth-form-box">
                    ...
                    <p class="text-muted mb-4">Register and open the dashboard.</p>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name') }}"
                                class="form-control @error('name') is-invalid @enderror" required autofocus placeholder="Your name">
                            @error('name')
                    ...
                    @if(Route::has('login'))
                        <div class="text-center mt-4 small">
                            ...
                            <a href="{{ route('login') }}" class="text-decoration-none fw-bold text-teal">Login</a>
                        </div>
                    @endif
                </div>
            </div>
